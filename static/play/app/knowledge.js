...
window.KNOWLEDGE = (function () {
  ...
  const TOPICS = [
    ...
    { keys: ['cognito', 'kernel', 'system 2', 'burn', 'failed', 'failure'],
      a: "cognito — a pure-Rust System 2 reasoning kernel on Burn, and a failed experiment. The premise — spend parameters on thinking, call tools for knowing — still looks right; my execution didn't survive contact with reality. The repo stays public because failure is data; the instinct moved into nibli." },
