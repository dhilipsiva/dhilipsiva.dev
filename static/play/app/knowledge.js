...
window.KNOWLEDGE = (function () {
  ...
  const TOPICS = [
    ...
    { keys: ['project', 'built', 'build', 'portfolio', 'made', 'created'],
      a: "Open source: nibli (symbolic reasoning, Rust→Wasm), cognito (System 2 reasoning kernel in Rust), botwork (Rust RPA), webapp-checklist (the most-starred), hostscli. Professional: Appknox, NuFlights, the Reckonsys years, ReWire. The projects app should be open right below — ask with a tech name to filter it." },
