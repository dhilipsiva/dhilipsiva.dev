...
window.KNOWLEDGE = (function () {
  ...
  const TOPICS = [
    ...
    { keys: ['nibli', 'hallucination', 'firewall', 'lojban', 'theorem'],
      a: "nibli — a zero-hallucination symbolic reasoning engine: Lojban in, first-order logic out; demand-driven backward-chaining with a proof trace on every conclusion. Zero-hallucination means inference soundness, not premise truth — like Lean: garbage premises in, garbage conclusions out, but the derivation is always valid. Even the name is Lojban: 'logically entails'. Try it live at dhilipsiva.dev/nibli — the real engine in your browser, with the GDPR and drug-interaction case studies. Favorite child." },
    { keys: ['demo', 'try nibli', 'try it', 'transparency triad', 'triad', 'proof tree'],
      a: "The live demo is at dhilipsiva.dev/nibli: the Transparency Triad — source, formal Lojban encoding, and a robotic back-translation — with the real engine compiled to WebAssembly. Run the book's GDPR and drug-interaction queries, retract a fact, and watch the proofs follow. Nothing leaves your tab." },
