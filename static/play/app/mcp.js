...
window.MCP = (function () {
  ...
  const ROUTES = [
    { app: 'projects', keys: ['project', 'projects', 'built', 'build', 'portfolio', 'made', 'created', 'work', 'repos', 'nibli', 'cognito', 'hostscli', 'awesome-rust-ml', 'appknox', 'nuflights', 'reckonsys', 'rewire', 'show me your rust', 'oss', 'open source'] },
