...
window.Brain = (function () {
  ...
  const MODELS = {
    twin: {
      ...
      model: 'https://huggingface.co/dhilipsiva/dhilipsiva-twin-gguf/resolve/main/dhilipsiva-twin-q8_0.gguf?v=6',
      tokenizer: 'https://huggingface.co/dhilipsiva/dhilipsiva-twin-gguf/resolve/main/tokenizer-smol.json?v=6',
      tools: false,
    ...
    twinq: {
      ...
      model: 'https://huggingface.co/dhilipsiva/dhilipsiva-twin-gguf/resolve/main/dhilipsiva-twin-qwen-q8_0.gguf?v=6',
      tokenizer: 'https://huggingface.co/dhilipsiva/dhilipsiva-twin-gguf/resolve/main/tokenizer-qwen.json?v=6',
      tools: true,
      sampling: { temp: 0, topP: 0.9, repeatPenalty: 1.05 },
